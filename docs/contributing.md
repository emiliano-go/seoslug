...
seoslug is pure Python with minimal dependencies.
...
Open a pull request.
Use a short description of what changed and why.
Maintainers will review within one week.

## Documentation

Documentation uses Markdown.
Follow the writing guide for tone and style.
Update or add pages in the docs directory.
